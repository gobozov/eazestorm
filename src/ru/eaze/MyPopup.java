...
public class MyPopup extends MyPopupBase{
  private static final Key<MyPopup> CHOOSE_BY_NAME_POPUP_IN_PROJECT_KEY = new Key<MyPopup>("ru.eaze.MyPopup");
  ...
  protected void showList() {
   ...
   // System.out.println( "show list executed" );
 ...
 /*
  @Nullable
  public static ru.eaze.MyPopup getActivePopup(@NotNull final Project project) {
 ...
 /* public static ru.eaze.MyPopup createPopup(final Project project, final ru.eaze.MyModel model/*, final PsiElement context) {
